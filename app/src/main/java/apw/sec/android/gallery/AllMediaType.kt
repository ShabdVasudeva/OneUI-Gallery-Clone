...
class AllMediaType(private val context: Context) {
    ...
    fun fetchMediaFiles(): List<MediaFile> {
        ...
        mediaFiles.addAll(fetchMedia(contentResolver, MediaStore.Images.Media.EXTERNAL_CONTENT_URI, "Android"))
        mediaFiles.addAll(fetchMedia(contentResolver, MediaStore.Video.Media.EXTERNAL_CONTENT_URI, "Android"))
        return mediaFiles
    }
